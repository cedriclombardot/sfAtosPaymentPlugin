  ...
  const PEER = 'sfAtosCartPeer';
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->payment_means = ($row[$startcol + 5] !== null) ? (string) $row[$startcol + 5] : null;
			$this->transmission_date = ($row[$startcol + 6] !== null) ? (string) $row[$startcol + 6] : null;
			$this->payment_time = ($row[$startcol + 7] !== null) ? (string) $row[$startcol + 7] : null;
			$this->response_code = ($row[$startcol + 8] !== null) ? (string) $row[$startcol + 8] : null;
			$this->payment_certificate = ($row[$startcol + 9] !== null) ? (string) $row[$startcol + 9] : null;
			$this->authorisation_id = ($row[$startcol + 10] !== null) ? (string) $row[$startcol + 10] : null;
			$this->currency_code = ($row[$startcol + 11] !== null) ? (int) $row[$startcol + 11] : null;
			$this->card_number = ($row[$startcol + 12] !== null) ? (string) $row[$startcol + 12] : null;
			$this->cvv_flag = ($row[$startcol + 13] !== null) ? (int) $row[$startcol + 13] : null;
			$this->cvv_response_code = ($row[$startcol + 14] !== null) ? (string) $row[$startcol + 14] : null;
			$this->bank_response_code = ($row[$startcol + 15] !== null) ? (string) $row[$startcol + 15] : null;
			$this->complementary_code = ($row[$startcol + 16] !== null) ? (int) $row[$startcol + 16] : null;
			$this->complementary_info = ($row[$startcol + 17] !== null) ? (string) $row[$startcol + 17] : null;
			$this->return_context = ($row[$startcol + 18] !== null) ? (string) $row[$startcol + 18] : null;
			$this->caddie = ($row[$startcol + 19] !== null) ? (string) $row[$startcol + 19] : null;
			$this->language = ($row[$startcol + 20] !== null) ? (string) $row[$startcol + 20] : null;
			$this->customer_id = ($row[$startcol + 21] !== null) ? (string) $row[$startcol + 21] : null;
			$this->order_id = ($row[$startcol + 22] !== null) ? (string) $row[$startcol + 22] : null;
			$this->customer_email = ($row[$startcol + 23] !== null) ? (string) $row[$startcol + 23] : null;
			$this->customer_ip_address = ($row[$startcol + 24] !== null) ? (string) $row[$startcol + 24] : null;
			$this->capture_day = ($row[$startcol + 25] !== null) ? (int) $row[$startcol + 25] : null;
			$this->capture_mode = ($row[$startcol + 26] !== null) ? (string) $row[$startcol + 26] : null;
			if ($row[$startcol + 27] !== null) {
				$this->data = fopen('php://memory', 'r+');
				fwrite($this->data, $row[$startcol + 27]);
				rewind($this->data);
			} else {
				$this->data = null;
			}
			...
			return $startcol + 28; // 28 = sfAtosCartPeer::NUM_COLUMNS - sfAtosCartPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true)
	{
		...
		$result = array(
			...
			$keys[5] => $this->getPaymentMeans(),
			$keys[6] => $this->getTransmissionDate(),
			$keys[7] => $this->getPaymentTime(),
			$keys[8] => $this->getResponseCode(),
			$keys[9] => $this->getPaymentCertificate(),
			$keys[10] => $this->getAuthorisationId(),
			$keys[11] => $this->getCurrencyCode(),
			$keys[12] => $this->getCardNumber(),
			$keys[13] => $this->getCvvFlag(),
			$keys[14] => $this->getCvvResponseCode(),
			$keys[15] => $this->getBankResponseCode(),
			$keys[16] => $this->getComplementaryCode(),
			$keys[17] => $this->getComplementaryInfo(),
			$keys[18] => $this->getReturnContext(),
			$keys[19] => $this->getCaddie(),
			$keys[20] => $this->getLanguage(),
			$keys[21] => $this->getCustomerId(),
			$keys[22] => $this->getOrderId(),
			$keys[23] => $this->getCustomerEmail(),
			$keys[24] => $this->getCustomerIpAddress(),
			$keys[25] => $this->getCaptureDay(),
			$keys[26] => $this->getCaptureMode(),
			$keys[27] => $this->getData(),
		);
		return $result;
	}
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[5], $arr)) $this->setPaymentMeans($arr[$keys[5]]);
		if (array_key_exists($keys[6], $arr)) $this->setTransmissionDate($arr[$keys[6]]);
		if (array_key_exists($keys[7], $arr)) $this->setPaymentTime($arr[$keys[7]]);
		if (array_key_exists($keys[8], $arr)) $this->setResponseCode($arr[$keys[8]]);
		if (array_key_exists($keys[9], $arr)) $this->setPaymentCertificate($arr[$keys[9]]);
		if (array_key_exists($keys[10], $arr)) $this->setAuthorisationId($arr[$keys[10]]);
		if (array_key_exists($keys[11], $arr)) $this->setCurrencyCode($arr[$keys[11]]);
		if (array_key_exists($keys[12], $arr)) $this->setCardNumber($arr[$keys[12]]);
		if (array_key_exists($keys[13], $arr)) $this->setCvvFlag($arr[$keys[13]]);
		if (array_key_exists($keys[14], $arr)) $this->setCvvResponseCode($arr[$keys[14]]);
		if (array_key_exists($keys[15], $arr)) $this->setBankResponseCode($arr[$keys[15]]);
		if (array_key_exists($keys[16], $arr)) $this->setComplementaryCode($arr[$keys[16]]);
		if (array_key_exists($keys[17], $arr)) $this->setComplementaryInfo($arr[$keys[17]]);
		if (array_key_exists($keys[18], $arr)) $this->setReturnContext($arr[$keys[18]]);
		if (array_key_exists($keys[19], $arr)) $this->setCaddie($arr[$keys[19]]);
		if (array_key_exists($keys[20], $arr)) $this->setLanguage($arr[$keys[20]]);
		if (array_key_exists($keys[21], $arr)) $this->setCustomerId($arr[$keys[21]]);
		if (array_key_exists($keys[22], $arr)) $this->setOrderId($arr[$keys[22]]);
		if (array_key_exists($keys[23], $arr)) $this->setCustomerEmail($arr[$keys[23]]);
		if (array_key_exists($keys[24], $arr)) $this->setCustomerIpAddress($arr[$keys[24]]);
		if (array_key_exists($keys[25], $arr)) $this->setCaptureDay($arr[$keys[25]]);
		if (array_key_exists($keys[26], $arr)) $this->setCaptureMode($arr[$keys[26]]);
		if (array_key_exists($keys[27], $arr)) $this->setData($arr[$keys[27]]);
	}
